export class Board {
    ...
    /**
     * Modifies internal board data structure and returns it reflecting a Worker building on an adjacent cell specified by Direction if it is possible to move there. Otherwise, returns unmodified board.
     * @param worker {string} worker to check neighboring cell for.
     * @param direction {string} direction to find cell.
    ...
    /**
     * Modifies internal board data structure and returns it reflecting a Worker moving to an adjacent cell specified by Direction if it is possible to move there. Otherwise, returns unmodified board.
     * @param worker {string} worker to check neighboring cell for.
     * @param direction {string} direction to find cell.
    ...
    /**
     * Returns location on board for a worker as cell indices.
     * @param worker {string}
