...
export class RuleChecker {
    ...
    constructor(board: Array<Array<any>>, worker: string, directions: string[]) {
        ...
        // create a board instance for the turn
     ...
     * TODO: think about whether it's good to directly manipulate the board vs. doing the check on a copy of the board, and changing the board later on through the actual game board's functions.
     */
    executeTurn(): string {
