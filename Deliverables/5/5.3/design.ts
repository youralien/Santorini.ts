...
class Player {
    ...
    board: Array<Array<Cell>>; // current state of the game board
...
class Strategy {
     ...
     * @param currentBoardState {Array<Array<Cell>>} current board to evaluate how good player is doing.
    ...
    /**
     * Uses board instance to compute valid potential next states of the board and their cooresponding heuristic values.
